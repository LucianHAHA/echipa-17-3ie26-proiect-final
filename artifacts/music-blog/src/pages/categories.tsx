  ...
  return (
    <div className="min-h-screen py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="mb-12">
          <h1 className="text-4xl md:text-6xl font-display font-bold text-foreground mb-4 glow-magenta">
            Frequencies
          </h1>
          <p className="text-xl font-body italic text-muted-foreground">
            Explore the spectrum of analog worship.
          </p>
                ...
                <Card className="h-full bg-card border-card-border hover:border-accent/50 hover:-translate-y-1 transition-all duration-300 card-glow cursor-pointer group">
                  <CardHeader>
                    <div className="flex justify-between items-start mb-4">
                      <Disc className="w-8 h-8 text-primary group-hover:text-accent transition-colors group-hover:animate-spin-slow" style={{ animationDuration: '4s' }} />
                    </div>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground font-body text-lg">
                      {category.attributes.description || `Explore articles about ${category.attributes.name.toLowerCase()}.`}
                    </p>
                  </CardContent>
                </Card>
              </Link>
